<template>
  <div class="tool-index">
    <ul class="tab-header">
      <li @click="changeTabType('component-config')" :class="{ active: tabType === 'component-config' }">组件配置</li>
      <li @click="changeTabType('page-config')" :class="{ active: tabType === 'page-config' }">页面配置</li>
      <li @click="changeTabType('page-manage')" :class="{ active: tabType === 'page-manage' }">页面管理</li>
    </ul>
    <div class="tab-container" v-show="tabType === 'component-config'">
      ...
      <div class="style-config">
        ...
        <div class="style-panel-title">容器样式</div>
        <StyleTool flag="container"></StyleTool>
        <div class="style-panel-title">自身样式</div>
        <StyleTool flag="self"></StyleTool>
    ...
    <div class="tab-container" v-show="tabType === 'page-manage'">
      <PageList></PageList>
    </div>
  </div>
</template>
