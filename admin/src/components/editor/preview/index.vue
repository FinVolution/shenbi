      ...
      <div class="preview-modal-right">
        ...
        <div class="preview-right-list">
          <div class="preview-selector active">
            <div class="preview-selector-container">
              <div :class="{ 'preview-scItem': true, active: previewMobileType == 'normal' }" @click="changePreviewMobileType('normal')">
                <SvgIcon class-name="mobile_normal_screen" icon-class="mobile_normal_screen"></SvgIcon>
                <p>主流机型</p>
              </div>
              <div :class="{ 'preview-scItem': true, active: previewMobileType == 'full' }" @click="changePreviewMobileType('full')">
                <SvgIcon class-name="mobile_full_screen" icon-class="mobile_full_screen"></SvgIcon>
                <p>全面屏</p>
              </div>
              <div :class="{ 'preview-scItem': true, active: previewMobileType == 'hair' }" @click="changePreviewMobileType('hair')">
                <SvgIcon class-name="mobile_hair_screen" icon-class="mobile_hair_screen"></SvgIcon>
                <p>刘海屏</p>
              </div>
              <div :class="{ 'preview-scItem': true, active: previewMobileType == 'small' }" @click="changePreviewMobileType('small')">
        ...
        <div class="preview-qrcode-box">
          <div class="preview-qrcode">
            <VueQr :logoSrc="logoSrc" :text="previewSrc" :size="200"></VueQr>
          </div>
        </div>
        <h4>落地页地址</h4>
        ...
        <div class="preview-url">
          ...
          <span class="preview-url-tip"> V3版本Landing页有5分钟的同步延时，请知悉。</span>
          <el-button plain size="mini" v-clipboard:copy="previewSrc" v-clipboard:success="onCopySuccexss">复制链接</el-button>
          <el-button plain size="mini" @click="openOnNewTab(previewSrc)">新标签页打开</el-button>
          <br />
        </div>
        <div class="reflush-container">
          <el-button plain size="medium" @click="reflush">刷新</el-button>
        </div>
